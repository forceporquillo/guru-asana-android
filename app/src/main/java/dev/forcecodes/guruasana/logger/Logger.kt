...
package dev.forcecodes.guruasana.logger
...
// Copied from Jake Wharton's Timber logging library.
...
class Logger private constructor() {
    ...
    abstract class Tree {
        ...
        private fun prepareLog(priority: Int, t: Throwable?, _message: String?, vararg args: Any?) {
